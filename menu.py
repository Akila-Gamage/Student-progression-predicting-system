...
def menu():
    ...
    while True:
        ...
        main_menu = input("Enter '1' to Open Students Version: \n"
                          ...
                          "Enter '3' to Open Staff Version with Horizontal Histogram: \n"
                          "Enter '4' to Open Staff Version with Vertical Histogram: \n"
                          "Enter '5' to Open Staff Version with list view : \n"
                          "Enter 'q' to Quit: ")
